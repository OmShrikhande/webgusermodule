...
const Home = () => {
  ...
  const [teamData, setTeamData] = useState([
    { id: 1, name: 'Alice Smith', status: 'Present', avatar: 'https://randomuser.me/api/portraits/women/44.jpg' },
    { id: 2, name: 'Bob Johnson', status: 'On Leave', avatar: 'https://randomuser.me/api/portraits/men/46.jpg' },
    { id: 3, name: 'Carol Williams', status: 'Half Day', avatar: 'https://randomuser.me/api/portraits/women/63.jpg' },
    { id: 4, name: 'David Brown', status: 'Absent', avatar: 'https://randomuser.me/api/portraits/men/22.jpg' },
    { id: 5, name: 'Eva Davis', status: 'Present', avatar: 'https://randomuser.me/api/portraits/women/14.jpg' }
  ])
  ...
  const [tasks, setTasks] = useState([
    { id: 1, title: 'Fix navigation bug', assignedTo: 'You', dueDate: '2023-06-08', status: 'In Progress' },
    { id: 2, title: 'Create user dashboard', assignedTo: 'Alice Smith', dueDate: '2023-06-12', status: 'Pending' },
    { id: 3, title: 'Update API documentation', assignedTo: 'You', dueDate: '2023-06-09', status: 'In Progress' }
  ])

  const [products, setProducts] = useState([
    { id: 1, name: 'Product A', image: 'https://via.placeholder.com/100', status: 'Active' },
    { id: 2, name: 'Product B', image: 'https://via.placeholder.com/100', status: 'In Development' },
    { id: 3, name: 'Product C', image: 'https://via.placeholder.com/100', status: 'Planned' }
  ])

  const [timeline, setTimeline] = useState([
    { id: 1, user: 'Alice Smith', action: 'completed task', item: 'Homepage redesign', time: '2 hours ago' },
    { id: 2, user: 'You', action: 'were assigned', item: 'API integration', time: '4 hours ago' },
    { id: 3, user: 'Bob Johnson', action: 'commented on', item: 'Database schema', time: '1 day ago' },
    { id: 4, user: 'Carol Williams', action: 'updated', item: 'Project timeline', time: '2 days ago' }
  ])
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.teamContainer}>
            {teamData.map(member => (
              <View key={member.id} style={styles.teamMember}>
                ...
                <View style={[styles.teamMemberStatus, { backgroundColor: getStatusColor(member.status) }]}>
            ...
            <View key={activity.id} style={styles.timelineItem}>
              ...
              <View style={styles.timelineContent}>
                <Text style={styles.timelineText}>
                  <Text style={styles.timelineUser}>{activity.user}</Text> {activity.action}{' '}
